...
export const initialCourses: Course[] = [
  {
    ...
    modules: [
      ...
      { id: '1-3', title: 'Документы и доступы', type: 'image', duration: '3 мин', imageUrl: 'https://picsum.photos/1200/720?random=201', description: 'Схема доступов в Confluence, Gmail, Slack и Jira.' },
  ...
  },
  {
    ...
    modules: [
      ...
      { id: '2-3', title: 'Кейс: сложный фидбек', type: 'image', duration: '4 мин', imageUrl: 'https://picsum.photos/1200/720?random=202', description: 'Схема разговора с несколькими опциями развилки.' },
